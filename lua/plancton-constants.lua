...
introConstants =
  ...
  INTRO_UNIT_A_PTS_COORD = {spriteX=0, spriteY=100, w=66, h=12},
  INTRO_UNIT_B_PTS_COORD = {spriteX=0, spriteY=112, w=70, h=12},
  INTRO_UNIT_C_PTS_COORD = {spriteX=0, spriteY=124, w=70, h=12},
  INTRO_SPACESHIP_PTS_COORD = {spriteX=0, spriteY=136, w=80, h=12},
